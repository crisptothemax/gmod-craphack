...
//constexpr auto Deg2Rad = [](float degrees) noexcept { return degrees * static_cast<float>(PI) / 180.0f; };
...
public:
	...
	Vector	operator/(float fl) const;
	inline void Rotate(const Vector& e);
...
inline void Vector::Rotate(const Vector& e)
{
	float _x, _y, _z;
